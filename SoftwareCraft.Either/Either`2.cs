...
public abstract class Either<TLeft, TRight>
{
	...
	public abstract Task<Either<ULeft, URight>> SelectAsync<ULeft, URight>(Func<TLeft, Task<ULeft>>   mapLeft,
	                                                                       Func<TRight, Task<URight>> mapRight);
	...
	public abstract Task<Either<ULeft, URight>> SelectManyAsync<ULeft, URight>(
		Func<TLeft, Task<Either<ULeft, URight>>>  mapLeft,
		Func<TRight, Task<Either<ULeft, URight>>> mapRight);
}